...
lyr_tempororyoutline_2.set('fieldLabels', {'FID': 'inline label - always visible', });
lyr_officebuilding_3.set('fieldLabels', {'FID': 'inline label - always visible', });
lyr_resort_4.set('fieldLabels', {'FID': 'inline label - always visible', });
lyr_truss_5.set('fieldLabels', {'FID': 'inline label - always visible', });
lyr_pond_6.set('fieldLabels', {'FID': 'inline label - always visible', });
lyr_biogas_7.set('fieldLabels', {'FID': 'inline label - always visible', });
lyr_tree1_8.set('fieldLabels', {'FID': 'inline label - always visible', });
lyr_staragro2_9.set('fieldLabels', {'sn': 'inline label - always visible', 'y': 'inline label - always visible', 'x': 'inline label - always visible', });
